...
It’s funny how you don’t realize how much you don’t know about something until you attempt to do it. I have seen people in my lab do similar analyses, I knew a few commands in python, and I had used ARGON and blast once or twice, so I thought this project would be a piece of cake. 

It wasn’t. 

Of course, getting a late start because of difficulty in data acquisition didn’t help, but I ran into a lot of obstacles. When you run CuffDiff, you are telling the program to count up genes and transcripts for sigGenes to quantify and classify as significantly different. Every time I ran this command for months, I either got zero genes/transcripts or an error message. I did all the troubleshooting I could, talked with the original author, our shared thesis advisor, and every P. antipodarum expert I knew, and I scoured the internet for any sort of forum or documentation that would tell me what I was doing wrong. I found minimal documentation or help from 2019 or more recent, so I knew I wasn’t going to find external help to figure out what I was doing wrong. No one I know in bioinformatics uses this program, so finally, I gave up and tried to use kallisto, which performs a similar statistical function. If I had continued, I would have used kallisto on the total annotated genome and created heat maps in another program, without distinguishing between the total annotated transcriptome and the transcripts that were focused on in the original paper. This could have been fine, but I didn’t have my transcriptome in the proper file format. I went back to cummeRbund and discovered that I was making the most novice mistake I can think of. I was working with my files within RStudio, and I thought that by opening a file within the file tab, I weas setting that file to my working directory. Looking back, it’s somewhat funny to think of all the struggling I did without thinking to check that until a few weeks ago, but my inexperience is definitely showing with that mistake. Once I figured out how to actually change my working directory within RStudio, the process was a success instantly, making me wonder if the lack of documentation is also due to the fact that these programs are extremely easy to use (for everyone else). 

I do still think the lack of recent documentation is a barrier to reproducibility, and it does raise a good point about the importance of continuing funding/work towards these programs so they don’t become obsolete. I also wonder how much the updates in R affect my work, and if they are to blame for the visual differences in the original figure and mine, but the arguably most important part (the numerical data) was the same, as far as I could see, so the conclusions and results are valid. 

Doing this project was very fun, difficult, and rewarding all at once. Even though the mistake I made was so easily fixed, because my inexperience made me look over it, I learned an incredible amount about other programs, researching, and bioinformatics. I also learned a lot about being in graduate school in general. This is actually my first semester in graduate school, but because I did my undergrad here, most faculty and other students assume that I know what I’m doing and that I’ve been a master's student for at least a year. I downsized my course load, compared to undergrad, but I didn’t really anticipate how much time I would *want* to spend on my classes, this one included. In undergrad, so many classes are just to fulfill some requirement, but because of the topic, the project, and the ungrading approach, I found myself wanting to put in more time than was necessary. I found myself doing extra readings, reading forums on stack overflow, trying out extra code/coding games, and spending a lot of time on my project, even though I couldn’t get anything to work and had nothing to upload to GitHub for weeks. In addition to the issues I’ve discussed, I have also been working as EMT for the entire pandemic, and I have been dealing with my own health issues, causing more significant obstacles. Doing this project gave me a lot of knowledge about bioinformatics, but it also provided a relatively low stress environment to make these mistakes and learn from my inexperience, my faults, and all of the other problems I ran into. 

As frustrating as learning all of this was at times, I also am very grateful I chose to reproduce this specific figure because of my thesis. We’re still narrowing down the exact topic of my thesis, but I will be looking at differential gene expression in my snails. I know how to do all of the wet lab parts of this experiment, so understanding how to go about learning the bioinformatics part and performing the analysis will help me when I’m doing similar experiments on my own populations. 
