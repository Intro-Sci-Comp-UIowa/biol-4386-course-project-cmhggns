...
### This folder contains all of the data you could possibly need to recreate my figure. 
Here, you have the full transcriptome, the CuffDiff output files (as zip files), etc. 
- To use the CuffDiff files, you need to clone this repository and unzip them.
